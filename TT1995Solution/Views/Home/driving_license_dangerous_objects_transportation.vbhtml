@Code
    ViewData("Title") = "ใบอนุญาติขับขี่ขนส่งวัตถุอันตราย"
End Code
...
<script>
    ...
    var permission_status = '@Session("35")'; //1 = Read Only, 2 = Read and Write
...
<script src="~/scripts/Home/driving_license_dangerous_objects_transportation.js"></script>
