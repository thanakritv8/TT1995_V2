                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="700">
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 25px;">
                                <input type="radio" id="txt14" name="txt14" value="แผ่นป้ายทะเบียนรถ"> แผ่นป้ายทะเบียนรถ<br>
                                <input type="radio" id="txt14" name="txt14" value="หนังสือแสดงการจดทะเบียน"> หนังสือแสดงการจดทะเบียน<br>
                                <input type="radio" id="txt14" name="txt14" value="เครื่องหมายแสดงการเสียภาษี"> เครื่องหมายแสดงการเสียภาษี
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="padding-top: 25px;">
