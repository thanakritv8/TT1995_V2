        ...
        onCellClick: function (e) {
            ...
            if (e.rowType == "header") {
                ...
                if (e.row.isSelected) {
                    ...
                    IsCheckBoxSelect.splice($.inArray(e.data.dpi_id, IsCheckBoxSelect), 1);
                }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            data.forEach(function (item) {
                ...
                if (item.dataField != "create_date" && item.dataField != "create_by_user_id" && item.dataField != "update_date" && item.dataField != "update_by_user_id" && item.dataField != "dpi_id" && item.dataField != "license_id" && item.dataField != "history" && item.dataField != "first_damages_view" && item.dataField != "group_update") {
