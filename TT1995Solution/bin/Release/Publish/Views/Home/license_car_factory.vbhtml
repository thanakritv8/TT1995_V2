@Code
    ViewData("Title") = "ใบอนุญาตรถเข้าโรงงาน"
End Code
<style>
    .custom-file {
        overflow-y: auto;
...
<div> <h4>ใบอนุญาตรถเข้าโรงงาน</h4> </div>
<div>
...
<script>
    ...
    var permission_status = '@Session("36")'; //1 = Read Only, 2 = Read and Write
...
<script src="~/scripts/Home/license_car_factory.js"></script>
